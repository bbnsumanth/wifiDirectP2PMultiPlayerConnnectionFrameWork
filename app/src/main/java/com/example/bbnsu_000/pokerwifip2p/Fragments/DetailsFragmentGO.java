 ...
 * {@link DetailsFragmentGO.OnFragmentInteractionListener} interface
 * to handle interaction events.
 */
public class DetailsFragmentGO extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_details_fragment_go, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        start_button = (Button) getActivity().findViewById(R.id.start_button);
        ...
        start_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mListener.onStartButton(name.getText().toString(),Integer.valueOf(buyin.getText().toString()));
            }
        });
